...
#define SPI_NAME                SPI  
#define SPI_HW_NAME             SwSPI_Master
...
#define CONCAT(name, function)                      name##function
    ...
    */
    ...
    //#define mmSPI_SpiUartClearTxBuffer                  CONCATENATE(SPI_NAME, _SpiUartClearTxBuffer)
    //#define mmSPI_SpiUartClearRxBuffer                  CONCATENATE(SPI_NAME, _SpiUartClearRxBuffer)    
    #define mmSPI_SpiUartPutArray(a, b)                 CONCATENATE(SPI_HW_NAME, _SendBuff(a, b)) 
    #define mmSPI_SpiUartWriteTxData(value)             CONCATENATE(SPI_HW_NAME, _SendByte(value))
    #define mmSPI_SpiUartReadRxData                     CONCATENATE(SPI_HW_NAME, _RecvByte)
    
    //#define mmSPI_GetMasterInterruptSource              CONCATENATE(SPI_HW_NAME, _GetMasterInterruptSource)
    //#define mmSPI_ClearMasterInterruptSource(value)     CONCATENATE(SPI_HW_NAME, _ClearMasterInterruptSource(value)) 
    //#define mmSPI_INTR_MASTER_SPI_DONE                  CONCATENATE(SPI_HW_NAME, _INTR_MASTER_SPI_DONE)    
...
//      while(SPIM_ReadStatus() == SPIM_STS_RX_FIFO_NOT_EMPTY);
        //CyDelayUs(M_DELAY_US);
        
        //while(SPIM_STS_RX_FIFO_NOT_EMPTY == SPIM_ReadRxStatus()){
