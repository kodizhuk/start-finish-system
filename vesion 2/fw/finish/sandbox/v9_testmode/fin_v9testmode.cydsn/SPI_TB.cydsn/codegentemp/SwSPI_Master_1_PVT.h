...
/* Device specific registers */
    ...
    /* Pin State */
    #define SwSPI_Master_1_MISO_PS_REG            (* (reg32 *) SwSPI_Master_1_SPI_MISO__PS)
    #define SwSPI_Master_1_MISO_PS_PTR            (  (reg32 *) SwSPI_Master_1_SPI_MISO__PS)
    /* Port Configuration */
    #define SwSPI_Master_1_MISO_PC_REG            (* (reg32 *) SwSPI_Master_1_SPI_MISO__PC)
    #define SwSPI_Master_1_MISO_PC_PTR            (  (reg32 *) SwSPI_Master_1_SPI_MISO__PC)
    /* Data Register */
    #define SwSPI_Master_1_MISO_DR_REG            (* (reg32 *) SwSPI_Master_1_SPI_MISO__DR)
    #define SwSPI_Master_1_MISO_DR_PTR            (  (reg32 *) SwSPI_Master_1_SPI_MISO__DR)
    
    
    /* Pin State */
    #define SwSPI_Master_1_MOSI_PS_REG            (* (reg32 *) SwSPI_Master_1_SPI_MOSI__PS)
    #define SwSPI_Master_1_MOSI_PS_PTR            (  (reg32 *) SwSPI_Master_1_SPI_MOSI__PS)
    /* Port Configuration */
    #define SwSPI_Master_1_MOSI_PC_REG            (* (reg32 *) SwSPI_Master_1_SPI_MOSI__PC)
    #define SwSPI_Master_1_MOSI_PC_PTR            (  (reg32 *) SwSPI_Master_1_SPI_MOSI__PC)
    /* Data Register */
    #define SwSPI_Master_1_MOSI_DR_REG            (* (reg32 *) SwSPI_Master_1_SPI_MOSI__DR)
    #define SwSPI_Master_1_MOSI_DR_PTR            (  (reg32 *) SwSPI_Master_1_SPI_MOSI__DR)

        /* Pin State */
    #define SwSPI_Master_1_SCK_PS_REG            (* (reg32 *) SwSPI_Master_1_SPI_SCK__PS)
    #define SwSPI_Master_1_SCK_PS_PTR            (  (reg32 *) SwSPI_Master_1_SPI_SCK__PS)
    /* Port Configuration */
    #define SwSPI_Master_1_SCK_PC_REG            (* (reg32 *) SwSPI_Master_1_SPI_SCK__PC)
    #define SwSPI_Master_1_SCK_PC_PTR            (  (reg32 *) SwSPI_Master_1_SPI_SCK__PC)
    /* Data Register */
    #define SwSPI_Master_1_SCK_DR_REG            (* (reg32 *) SwSPI_Master_1_SPI_SCK__DR)
    #define SwSPI_Master_1_SCK_DR_PTR            (  (reg32 *) SwSPI_Master_1_SPI_SCK__DR)
    
    
    /* Pin State */
    #define SwSPI_Master_1_CS_PS_REG            (* (reg32 *) SwSPI_Master_1_SPI_CS__PS)
    #define SwSPI_Master_1_CS_PS_PTR            (  (reg32 *) SwSPI_Master_1_SPI_CS__PS)
    /* Port Configuration */
    #define SwSPI_Master_1_CS_PC_REG            (* (reg32 *) SwSPI_Master_1_SPI_CS__PC)
    #define SwSPI_Master_1_CS_PC_PTR            (  (reg32 *) SwSPI_Master_1_SPI_CS__PC)
    /* Data Register */
    #define SwSPI_Master_1_CS_DR_REG            (* (reg32 *) SwSPI_Master_1_SPI_CS__DR)
    #define SwSPI_Master_1_CS_DR_PTR            (  (reg32 *) SwSPI_Master_1_SPI_CS__DR)
...
#define SwSPI_Master_1_CLK                     ((uint8) \
                                                (((uint8) 0x01u) << SwSPI_Master_1_SPI_SCK__SHIFT))
#define SwSPI_Master_1_MOSI                      ((uint8) \
                                                (((uint8) 0x01u) << SwSPI_Master_1_SPI_MOSI__SHIFT))
...
#define SwSPI_Master_1_MOSI_MASK               SwSPI_Master_1_SPI_MOSI__MASK
#define SwSPI_Master_1_MOSI_SHIFT              SwSPI_Master_1_SPI_MOSI__SHIFT

#define SwSPI_Master_1_SCK_MASK               SwSPI_Master_1_SPI_SCK__MASK
#define SwSPI_Master_1_SCK_SHIFT              SwSPI_Master_1_SPI_SCK__SHIFT

#define SwSPI_Master_1_CS_MASK               SwSPI_Master_1_SPI_CS__MASK
#define SwSPI_Master_1_CS_SHIFT              SwSPI_Master_1_SPI_CS__SHIFT
