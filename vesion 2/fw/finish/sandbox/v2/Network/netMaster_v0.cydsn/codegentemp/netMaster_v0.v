// ======================================================================
// netMaster_v0.v generated from TopDesign.cysch
// 08/03/2016 at 17:36
...
module SW_Tx_UART_v1_50_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3de79718-ca31-4b1c-a319-c8959403ff9e/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
    ...
    SW_Tx_UART_v1_50_1 SW_UART_DEBUG ();
