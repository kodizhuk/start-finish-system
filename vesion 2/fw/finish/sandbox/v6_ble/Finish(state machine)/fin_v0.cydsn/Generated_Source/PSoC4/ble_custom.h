...
#define CYBLE_SFSYSTEMSERVICE_SERVICE_INDEX   (0x00u) /* Index of SFsystemService service in the cyBle_customs array */
#define CYBLE_SFSYSTEMSERVICE_ID_CHAR_INDEX   (0x00u) /* Index of ID characteristic */
#define CYBLE_SFSYSTEMSERVICE_ID_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_SFSYSTEMSERVICE_ID_ID_CCCD_DESC_INDEX   (0x01u) /* Index of ID_CCCD descriptor */
#define CYBLE_SFSYSTEMSERVICE_TIME_START_CHAR_INDEX   (0x01u) /* Index of time_start characteristic */
#define CYBLE_SFSYSTEMSERVICE_TIME_START_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_SFSYSTEMSERVICE_TIME_START_TIMESTARTCCCD_DESC_INDEX   (0x01u) /* Index of timeStartCCCD descriptor */
#define CYBLE_SFSYSTEMSERVICE_TIME_FINISH_CHAR_INDEX   (0x02u) /* Index of time_finish characteristic */
#define CYBLE_SFSYSTEMSERVICE_TIME_FINISH_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_SFSYSTEMSERVICE_TIME_FINISH_TIMEFINISHCCCD_DESC_INDEX   (0x01u) /* Index of timeFinishCCCD descriptor */
#define CYBLE_SFSYSTEMSERVICE_TIME_RESULT_CHAR_INDEX   (0x03u) /* Index of time_result characteristic */
#define CYBLE_SFSYSTEMSERVICE_TIME_RESULT_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_SFSYSTEMSERVICE_TIME_RESULT_TIMERESULTCCCD_DESC_INDEX   (0x01u) /* Index of timeResultCCCD descriptor */
#define CYBLE_SFSYSTEMSERVICE_SYSTEM_STATUS_CHAR_INDEX   (0x04u) /* Index of system_status characteristic */
#define CYBLE_SFSYSTEMSERVICE_SYSTEM_STATUS_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
