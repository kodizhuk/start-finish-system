...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL2, 0x0005B800u);
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL3, 0x00068200u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL9), 0x00000044u);
	...
	CyIntEnable(8u);
	CY_SET_REG32((void *)(CYREG_WDT_MATCH), 0xFFFF0020u);
	CY_SET_REG32((void *)(CYREG_WDT_CONFIG), 0x40000505u);
	CY_SET_REG32((void *)(CYREG_WDT_CONTROL), 0x00000808u);
	while ((CY_GET_XTND_REG32((void CYFAR *)(CYREG_WDT_CONTROL)) & 0x00000808u) != 0u) { }
	CY_SET_REG32((void *)(CYREG_WDT_CONTROL), 0x00000101u);
}
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0xEE9900EEu);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00DB1DA4u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC2), 0x00000020u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000094u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x009B6086u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x00000023u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00036192u);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x0000000Fu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00036C90u);
