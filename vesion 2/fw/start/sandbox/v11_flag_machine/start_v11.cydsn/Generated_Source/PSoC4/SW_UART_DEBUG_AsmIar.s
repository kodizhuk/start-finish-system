;==============================================================================
;
; File Name: SW_UART_DEBUG_AsmIar.s
; Version 1.50
;
;  Description:
...
;==============================================================================
    ...
    IMPORT SW_UART_DEBUG_pinNumber
    IMPORT SW_UART_DEBUG_pinPortNumber
    IMPORT SW_UART_DEBUG_pinDrAdress
    ...
    PUBLIC SW_UART_DEBUG_PutChar
    THUMB


;------------------------------------------------------------------------------
; Function Name: SW_UART_DEBUG_PutChar
;------------------------------------------------------------------------------
;
; Summary:
...
bitTxLoop:
    ...
    DATA
PIN_NUMBER dc32 SW_UART_DEBUG_pinNumber
PORT_NUMBER dc32 SW_UART_DEBUG_pinPortNumber
PORT_DR_ADDRESS dc32 SW_UART_DEBUG_pinDrAdress
FREQ dc32 cydelayFreqHz
BAUD_RATE dc32 19200
