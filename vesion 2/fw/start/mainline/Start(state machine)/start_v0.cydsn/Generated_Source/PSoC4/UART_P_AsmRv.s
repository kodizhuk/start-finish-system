...
;==============================================================================
    ...
    IMPORT UART_P_pinNumber
    IMPORT UART_P_pinPortNumber
    IMPORT UART_P_pinDrAdress
...
; void UART_P_PutChar(uint8 txDataByte)
    ALIGN 8
UART_P_PutChar FUNCTION
    EXPORT UART_P_PutChar
...
PIN_NUMBER DCD UART_P_pinNumber
PORT_NUMBER DCD UART_P_pinPortNumber
PORT_DR_ADDRESS DCD UART_P_pinDrAdress
