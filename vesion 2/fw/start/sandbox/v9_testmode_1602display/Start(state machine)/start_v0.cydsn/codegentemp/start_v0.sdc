...
# Project: D:\Cypress\system-start-finish\vesion 2\fw\start\sandbox\v9_testmode_1602display\Start(state machine)\start_v0.cydsn\start_v0.cyprj
# Date: Thu, 26 Jan 2017 15:55:08 GMT
#set_units -time ns
...
# Component constraints for D:\Cypress\system-start-finish\vesion 2\fw\start\sandbox\v9_testmode_1602display\Start(state machine)\start_v0.cydsn\TopDesign\TopDesign.cysch
# Project: D:\Cypress\system-start-finish\vesion 2\fw\start\sandbox\v9_testmode_1602display\Start(state machine)\start_v0.cydsn\start_v0.cyprj
# Date: Thu, 26 Jan 2017 15:55:05 GMT
