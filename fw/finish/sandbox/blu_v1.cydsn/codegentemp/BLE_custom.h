...
#define CYBLE_CAPSENSE_SLIDER_CHAR_HANDLE   (0x000Eu) /* Handle of Slider characteristic */
#define CYBLE_CAPSENSE_SLIDER_SLIDERCCCD_DESC_HANDLE   (0x000Fu) /* Handle of SliderCCCD descriptor */
