...
# Project: D:\Cypress\system-start-finish\vesion 2\fw\finish\sandbox\v9_testmode_1602display\Finish(state machine)\fin_v0.cydsn\fin_v0.cyprj
# Date: Fri, 27 Jan 2017 12:39:25 GMT
#set_units -time ns
...
# Component constraints for D:\Cypress\system-start-finish\vesion 2\fw\finish\sandbox\v9_testmode_1602display\Finish(state machine)\fin_v0.cydsn\TopDesign\TopDesign.cysch
# Project: D:\Cypress\system-start-finish\vesion 2\fw\finish\sandbox\v9_testmode_1602display\Finish(state machine)\fin_v0.cydsn\fin_v0.cyprj
# Date: Fri, 27 Jan 2017 12:39:19 GMT
