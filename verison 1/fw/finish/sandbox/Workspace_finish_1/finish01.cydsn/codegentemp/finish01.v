...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4bf37d92-b2d8-42f8-b2f0-4ff05fc672a6/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__finish_net;
	wire [0:0] tmpFB_0__finish_net;
	wire [0:0] tmpIO_0__finish_net;
	electrical [0:0] tmpSIOVREF__finish_net;
	...
	cy_psoc3_pins_v1_10
		...
		finish
		 (.oe(tmpOE__finish_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__finish_net[0:0]}),
		  .io({tmpIO_0__finish_net[0:0]}),
		  .siovref(tmpSIOVREF__finish_net),
		  .interrupt({Net_30}),
		  .annotation({Net_29}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__finish_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 FINISH_BUTTON (
        .connect({
            Net_36,
            Net_29
        })
    );
    defparam FINISH_BUTTON.comp_name = "SwitchSPST_v1_0";
    defparam FINISH_BUTTON.port_names = "T1, T2";
    defparam FINISH_BUTTON.width = 2;
	...
	cy_clock_v1_0
		#(.id("870110cf-5012-4dfe-976d-306a7fab263e"),
		  .source_clock_id(""),
		  .divisor(0),
