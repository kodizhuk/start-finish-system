...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* SFsystemService service */
    {
        0x000Cu, /* Handle of the SFsystemService service */ 
        {

            /* ID characteristic */
            {
                0x000Eu, /* Handle of the ID characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x000Fu, /* Handle of the Characteristic User Description descriptor */ 
                    0x0010u, /* Handle of the ID_CCCD descriptor */ 
                }, 
            },

            /* time_start characteristic */
            {
                0x0012u, /* Handle of the time_start characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0013u, /* Handle of the Characteristic User Description descriptor */ 
                    0x0014u, /* Handle of the timeStartCCCD descriptor */ 
                }, 
            },

            /* time_finish characteristic */
            {
                0x0016u, /* Handle of the time_finish characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0017u, /* Handle of the Characteristic User Description descriptor */ 
                    0x0018u, /* Handle of the timeFinishCCCD descriptor */ 
                }, 
            },

            /* time_result characteristic */
            {
                0x001Au, /* Handle of the time_result characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x001Bu, /* Handle of the Characteristic User Description descriptor */ 
                    0x001Cu, /* Handle of the timeResultCCCD descriptor */ 
                }, 
            },

            /* system_status characteristic */
            {
                0x001Eu, /* Handle of the system_status characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x001Fu, /* Handle of the Characteristic User Description descriptor */ 
                    0x0020u, /* Handle of the statusCCCd descriptor */ 
                }, 
            },

            /* unixTime characteristic */
            {
                0x0022u, /* Handle of the unixTime characteristic */ 
