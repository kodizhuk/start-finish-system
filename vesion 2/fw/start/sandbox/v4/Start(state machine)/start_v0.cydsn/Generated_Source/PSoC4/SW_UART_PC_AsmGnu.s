...
.global SW_UART_PC_pinNumber
.global SW_UART_PC_pinPortNumber
...
.global SW_UART_PC_PutChar
.func SW_UART_PC_PutChar, SW_UART_PC_PutChar
.type SW_UART_PC_PutChar, %function
.thumb_func
SW_UART_PC_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word SW_UART_PC_pinNumber
PORT_NUMBER:
    .word SW_UART_PC_pinPortNumber
PORT_DR_ADDRESS:
    .word SW_UART_PC_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 115200
