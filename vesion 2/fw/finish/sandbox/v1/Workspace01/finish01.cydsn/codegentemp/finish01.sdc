...
# Date: Thu, 07 Jul 2016 19:56:33 GMT
#set_units -time ns
create_clock -name {UART_XB_SCBCLK(FFB)} -period 729.16666666666663 -waveform {0 364.583333333333} [list [get_pins {ClockBlock/ff_div_1}]]
...
create_generated_clock -name {UART_XB_SCBCLK} -source [get_pins {ClockBlock/hfclk}] -edges {1 35 71} [list]
