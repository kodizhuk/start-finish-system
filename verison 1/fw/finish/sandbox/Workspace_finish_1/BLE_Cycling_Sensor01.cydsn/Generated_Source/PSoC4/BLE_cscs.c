...
const CYBLE_CSCSS_T cyBle_cscss =
{
    0x001Bu,    /* Handle of the CSCS service */
    {
        
        /* CSC Measurement characteristic */
        {
            0x001Du, /* Handle of the CSC Measurement characteristic */ 
        ...
        {
            0x0020u, /* Handle of the CSC Feature characteristic */ 
        ...
        {
            0x0022u, /* Handle of the Sensor Location characteristic */ 
        ...
        {
            0x0024u, /* Handle of the SC Control Point characteristic */ 
