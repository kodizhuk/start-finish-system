...
uint8 const CYCODE LCD_1_customFonts[] = \
{
    ...
    /* Character LCD_1_CUSTOM_2   */
        0x00u,    0x0Eu,    0x04u,    0x04u,    0x04u,    0x04u,    0x00u,    0x00u, \
...
/*******************************************************************************
* Function Name: LCD_1_LoadCustomFonts
********************************************************************************
*
* Summary:
...
void LCD_1_LoadCustomFonts(uint8 const customData[]) 
{
    ...
    */
    LCD_1_WriteControl(LCD_1_CGRAM_0);

    /* Load in the 64 bytes of CustomChar Data */
    for(indexU8 = 0u; indexU8 < LCD_1_CUSTOM_CHAR_SET_LEN; indexU8++)
    {
        LCD_1_WriteData(customData[indexU8]);
    }

    LCD_1_IsReady();
    LCD_1_WriteControl(LCD_1_DDRAM_0);
}
