...
.global UART_P_pinNumber
.global UART_P_pinPortNumber
...
.global UART_P_PutChar
.func UART_P_PutChar, UART_P_PutChar
.type UART_P_PutChar, %function
.thumb_func
UART_P_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word UART_P_pinNumber
PORT_NUMBER:
    .word UART_P_pinPortNumber
PORT_DR_ADDRESS:
    .word UART_P_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 115200
