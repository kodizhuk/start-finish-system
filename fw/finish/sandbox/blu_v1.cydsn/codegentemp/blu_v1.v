// ======================================================================
// blu_v1.v generated from TopDesign.cysch
// 04/28/2016 at 22:38
...
module BLE_v2_30_0 (
	...
	cy_clock_v1_0
		#(.id("5b9c3b0b-b84e-4528-ae98-bab45441837a/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module CapSense_CSD_P4_v2_40_3 ;
	...
	cy_clock_v1_0
		#(.id("049900f1-df02-4bfa-9399-3805475a273e/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("049900f1-df02-4bfa-9399-3805475a273e/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("049900f1-df02-4bfa-9399-3805475a273e/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
	...
	cy_clock_v1_0
		#(.id("049900f1-df02-4bfa-9399-3805475a273e/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("1ff72c45-6ba5-4f44-99ac-9c16a1626432"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ccba2856-3f62-4ead-b6be-d52f2e8edfcf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
