    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x88u] = {
    /* Device Name */
    (uint8)'C', (uint8)'y', (uint8)'c', (uint8)'l', (uint8)'i', (uint8)'n', (uint8)'g', (uint8)' ', (uint8)'S', (uint8)'e',
(uint8)'n', (uint8)'s', (uint8)'o', (uint8)'r', 
    ...
    0x14u, 0x08u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 
    ...
    /* SC Control Point */
    0x01u, 0x00u, 0x00u, 0x00u, 0x01u, 0x00u, 
...
(uint8)'r', 
    ...
    /* Model Number String */
    (uint8)'C', (uint8)'P', (uint8)'S', (uint8)' ', (uint8)'v', (uint8)'1', (uint8)'.', (uint8)'0', (uint8)' ', (uint8)'&',
(uint8)' ', (uint8)'C', (uint8)'S', (uint8)'C', (uint8)'P', (uint8)' ', (uint8)'v', (uint8)' ', (uint8)'1', (uint8)'.',
(uint8)'0', 
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x000Eu, (void *)&cyBle_attValues[28] }, /* Cycling Power Measurement */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0002u, (void *)&cyBle_attValues[42] }, /* Server Characteristic Configuration */
    { 0x0004u, (void *)&cyBle_attValues[44] }, /* Cycling Power Feature */
    { 0x0001u, (void *)&cyBle_attValues[48] }, /* Sensor Location */
    { 0x0005u, (void *)&cyBle_attValues[49] }, /* Cycling Power Vector */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[4] }, /* Client Characteristic Configuration */
    { 0x0005u, (void *)&cyBle_attValues[54] }, /* Cycling Power Control Point */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[6] }, /* Client Characteristic Configuration */
    { 0x000Bu, (void *)&cyBle_attValues[59] }, /* CSC Measurement */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[8] }, /* Client Characteristic Configuration */
    { 0x0002u, (void *)&cyBle_attValues[70] }, /* CSC Feature */
    { 0x0001u, (void *)&cyBle_attValues[72] }, /* Sensor Location */
    { 0x0006u, (void *)&cyBle_attValues[73] }, /* SC Control Point */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[10] }, /* Client Characteristic Configuration */
    { 0x0015u, (void *)&cyBle_attValues[79] }, /* Manufacturer Name String */
    { 0x0015u, (void *)&cyBle_attValues[100] }, /* Model Number String */
    { 0x000Fu, (void *)&cyBle_attValues[121] }, /* Hardware Revision String */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x2Cu] = {
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x001Au, {{0x1818u, NULL}}                           },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00001101u /* br,ntf */, 0x0010u, {{0x2A63u, NULL}}                           },
    { 0x000Eu, 0x2A63u /* Cycling Power Measurement           */, 0x00001100u /* br,ntf */, 0x0010u, {{0x000Eu, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x0010u, 0x2903u /* Server Characteristic Configuration */, 0x00000A04u /* rd,wr  */, 0x0010u, {{0x0002u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0012u, {{0x2A65u, NULL}}                           },
    { 0x0012u, 0x2A65u /* Cycling Power Feature               */, 0x00000209u /* rd     */, 0x0012u, {{0x0004u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0014u, {{0x2A5Du, NULL}}                           },
    { 0x0014u, 0x2A5Du /* Sensor Location                     */, 0x00000209u /* rd     */, 0x0014u, {{0x0001u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00001001u /* ntf    */, 0x0017u, {{0x2A64u, NULL}}                           },
    { 0x0016u, 0x2A64u /* Cycling Power Vector                */, 0x00001000u /* ntf    */, 0x0017u, {{0x0005u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0017u, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr  */, 0x0017u, {{0x0002u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0018u, 0x2803u /* Characteristic                      */, 0x00002801u /* wr,ind */, 0x001Au, {{0x2A66u, NULL}}                           },
    { 0x0019u, 0x2A66u /* Cycling Power Control Point         */, 0x0000280Au /* wr,ind */, 0x001Au, {{0x0005u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x001Au, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr  */, 0x001Au, {{0x0002u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x001Bu, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x0025u, {{0x1816u, NULL}}                           },
    { 0x001Cu, 0x2803u /* Characteristic                      */, 0x00001001u /* ntf    */, 0x001Eu, {{0x2A5Bu, NULL}}                           },
    { 0x001Du, 0x2A5Bu /* CSC Measurement                     */, 0x00001000u /* ntf    */, 0x001Eu, {{0x000Bu, (void *)&cyBle_attValuesLen[14]}} },
    { 0x001Eu, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr  */, 0x001Eu, {{0x0002u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x001Fu, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0020u, {{0x2A5Cu, NULL}}                           },
    { 0x0020u, 0x2A5Cu /* CSC Feature                         */, 0x00000209u /* rd     */, 0x0020u, {{0x0002u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0021u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0022u, {{0x2A5Du, NULL}}                           },
    { 0x0022u, 0x2A5Du /* Sensor Location                     */, 0x00000209u /* rd     */, 0x0022u, {{0x0001u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x0023u, 0x2803u /* Characteristic                      */, 0x00002801u /* wr,ind */, 0x0025u, {{0x2A55u, NULL}}                           },
    { 0x0024u, 0x2A55u /* SC Control Point                    */, 0x0000280Au /* wr,ind */, 0x0025u, {{0x0006u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x0025u, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr  */, 0x0025u, {{0x0002u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x0026u, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x002Cu, {{0x180Au, NULL}}                           },
    { 0x0027u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0028u, {{0x2A29u, NULL}}                           },
    { 0x0028u, 0x2A29u /* Manufacturer Name String            */, 0x00000209u /* rd     */, 0x0028u, {{0x0015u, (void *)&cyBle_attValuesLen[20]}} },
    { 0x0029u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x002Au, {{0x2A24u, NULL}}                           },
    { 0x002Au, 0x2A24u /* Model Number String                 */, 0x00000209u /* rd     */, 0x002Au, {{0x0015u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x002Bu, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x002Cu, {{0x2A27u, NULL}}                           },
    { 0x002Cu, 0x2A27u /* Hardware Revision String            */, 0x00000209u /* rd     */, 0x002Cu, {{0x000Fu, (void *)&cyBle_attValuesLen[22]}} },
};
