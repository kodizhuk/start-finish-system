...
module top ;
	...
	cy_clock_v1_0
		#(.id("14e0b768-e414-498e-b3b0-7e9b00e7ce77"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("14239fc2-16f1-4816-a578-a3a9952ef38d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ddeb1cf1-3a70-4e46-b294-0cb6309eeeba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
