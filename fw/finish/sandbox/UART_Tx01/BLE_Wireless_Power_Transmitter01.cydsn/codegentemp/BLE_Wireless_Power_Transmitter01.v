// ======================================================================
// BLE_Wireless_Power_Transmitter01.v generated from TopDesign.cysch
// 04/28/2016 at 11:13
...
module BLE_v2_30_0 (
	...
	cy_clock_v1_0
		#(.id("c7dde2c0-01a7-4d67-811b-724b52b29732/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__Scanning_LED_net;
	wire [0:0] tmpFB_0__Scanning_LED_net;
	wire [0:0] tmpIO_0__Scanning_LED_net;
	wire [0:0] tmpINTERRUPT_0__Scanning_LED_net;
	electrical [0:0] tmpSIOVREF__Scanning_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d705aeb9-258f-430b-ae5b-ef2b8547e6d1"),
		  ...
		  .input_buffer_sel(2'b00))
		Scanning_LED
		 (.oe(tmpOE__Scanning_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Scanning_LED_net[0:0]}),
		  .io({tmpIO_0__Scanning_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Scanning_LED_net),
		  .interrupt({tmpINTERRUPT_0__Scanning_LED_net[0:0]}),
		  .annotation({Net_204}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Scanning_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
