// ======================================================================
// start_v11.v generated from TopDesign.cysch
// 07/27/2017 at 21:53
...
module SwSPI_Master_v1_20_5 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b9e52874-e10c-44d0-98d1-9b4059c07a18/8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b9e52874-e10c-44d0-98d1-9b4059c07a18/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b9e52874-e10c-44d0-98d1-9b4059c07a18/a67a8f19-88f1-4f46-a8b4-672077a3e1c9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b9e52874-e10c-44d0-98d1-9b4059c07a18/e5893258-c96e-41a9-a414-5c745b30282e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    TCPWM_P4_v2_10_2 TimerTestMode (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_psoc3_pins_v1_10
		#(.id("353c4673-212d-4d41-9cf8-89201914da5f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d21c960c-78cd-498a-aaaa-69a29895e82e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SwSPI_Master_v1_20_5 SwSPI_Master ();
	...
	wire [0:0] tmpOE__BtnUp_net;
	wire [0:0] tmpIO_0__BtnUp_net;
	wire [0:0] tmpINTERRUPT_0__BtnUp_net;
	electrical [0:0] tmpSIOVREF__BtnUp_net;

	cy_psoc3_pins_v1_10
		#(.id("fc4cddad-b874-48db-b1b6-abd82dc4786b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		BtnUp
		 (.oe(tmpOE__BtnUp_net),
		  .y({1'b0}),
		  .fb({Net_384}),
		  .io({tmpIO_0__BtnUp_net[0:0]}),
		  .siovref(tmpSIOVREF__BtnUp_net),
		  .interrupt({tmpINTERRUPT_0__BtnUp_net[0:0]}),
		  .annotation({Net_361}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BtnUp_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BtnDown_net;
	wire [0:0] tmpIO_0__BtnDown_net;
	wire [0:0] tmpINTERRUPT_0__BtnDown_net;
	electrical [0:0] tmpSIOVREF__BtnDown_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a4f6e9d0-dc25-4f83-93ba-01b4d37877b7"),
		  ...
		  .input_buffer_sel(2'b00))
		BtnDown
		 (.oe(tmpOE__BtnDown_net),
		  .y({1'b0}),
		  .fb({Net_383}),
		  .io({tmpIO_0__BtnDown_net[0:0]}),
		  .siovref(tmpSIOVREF__BtnDown_net),
		  .interrupt({tmpINTERRUPT_0__BtnDown_net[0:0]}),
		  .annotation({Net_363}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BtnDown_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_185 = ~Net_389;


    assign Net_391 = ~Net_384;


    assign Net_392 = ~Net_383;
