    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'p', (uint8)'s', (uint8)'o', (uint8)'c', (uint8)'-', (uint8)'0', (uint8)'4', (uint8)'2', (uint8)'b', (uint8)'l',
(uint8)'e', 
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[25] }, /* Slider */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x0Fu] = {
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x000Fu, {{0xCAB5u, NULL}}                           },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf */, 0x000Fu, {{0xCAA2u, NULL}}                           },
    { 0x000Eu, 0xCAA2u /* Slider                              */, 0x00011201u /* rd,ntf */, 0x000Fu, {{0x0001u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Fu, 0x2902u /* SliderCCCD                          */, 0x00010A04u /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[6]}} },
};
