...
// SW_Tx_UART_v1_50(BaudRate=9600, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SW_uartDebug, CY_INSTANCE_SHORT_NAME=SW_uartDebug, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=SW_uartDebug, )
...
module top ;
    ...
    UART_v2_50_2 UART_XB2 (
        ...
        .rx_data(Net_70),
        .rx_clk(Net_71));
    defparam UART_XB2.Address1 = 0;
    defparam UART_XB2.Address2 = 0;
    defparam UART_XB2.EnIntRXInterrupt = 1;
    defparam UART_XB2.EnIntTXInterrupt = 1;
    defparam UART_XB2.FlowControl = 0;
    defparam UART_XB2.HalfDuplexEn = 0;
    defparam UART_XB2.HwTXEnSignal = 0;
    defparam UART_XB2.NumDataBits = 8;
    defparam UART_XB2.NumStopBits = 1;
    defparam UART_XB2.ParityType = 2;
    defparam UART_XB2.RXEnable = 1;
    defparam UART_XB2.TXEnable = 1;
    ...
    SW_Tx_UART_v1_50_3 SW_uartDebug ();
