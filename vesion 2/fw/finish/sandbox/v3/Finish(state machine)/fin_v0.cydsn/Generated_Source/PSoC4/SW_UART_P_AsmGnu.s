...
.global SW_UART_P_pinNumber
.global SW_UART_P_pinPortNumber
...
.global SW_UART_P_PutChar
.func SW_UART_P_PutChar, SW_UART_P_PutChar
.type SW_UART_P_PutChar, %function
.thumb_func
SW_UART_P_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word SW_UART_P_pinNumber
PORT_NUMBER:
    .word SW_UART_P_pinPortNumber
PORT_DR_ADDRESS:
    .word SW_UART_P_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 9600
