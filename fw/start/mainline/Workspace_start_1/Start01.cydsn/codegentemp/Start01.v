...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ea43e167-c827-431d-8305-18538c04f3b7/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("15a0ca87-b141-40ca-a145-b65eea01ad56"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    defparam START_BUTTON.comp_name = "SwitchSPST_v1_0";
    defparam START_BUTTON.port_names = "T1, T2";
    defparam START_BUTTON.width = 2;
	...
	wire [0:0] tmpFB_0__wired_net;
	wire [0:0] tmpIO_0__wired_net;
	wire [0:0] tmpINTERRUPT_0__wired_net;
	electrical [0:0] tmpSIOVREF__wired_net;

	cy_psoc3_pins_v1_10
		#(.id("e94f983c-b694-4b1e-bb6c-fd60cf2bb45e"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		wired
		 (.oe(tmpOE__wired_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__wired_net[0:0]}),
		  .io({tmpIO_0__wired_net[0:0]}),
		  .siovref(tmpSIOVREF__wired_net),
		  .interrupt({tmpINTERRUPT_0__wired_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__wired_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cancel_net;
	wire [0:0] tmpFB_0__cancel_net;
	wire [0:0] tmpIO_0__cancel_net;
	electrical [0:0] tmpSIOVREF__cancel_net;

	cy_psoc3_pins_v1_10
		#(.id("97f2170f-8f75-420b-ad97-284f8db25cb2"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	assign tmpOE__cancel_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
