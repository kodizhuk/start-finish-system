...
// CharLCD_v2_20(ConversionRoutines=true, CUSTOM0="0,E,8,8,8,E,0,0,", CUSTOM1="0,A,A,4,4,4,0,0,", CUSTOM2="0,E,4,4,4,4,0,0,", CUSTOM3="0,E,A,C,A,A,0,0,", CUSTOM4="0,E,8,C,8,E,0,0,", CUSTOM5="0,E,8,E,2,E,0,0,", CUSTOM6="0,E,8,E,2,E,0,0,", CUSTOM7="0,4,4,4,0,4,0,0,", CustomCharacterSet=3, TypeReplacementString=uint32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=CharLCD_v2_20, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD_1, CY_INSTANCE_SHORT_NAME=LCD_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=LCD_1, )
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b1c99be5-47f1-46a6-8b7f-cab32771727d/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Gate_Start_net;
	wire [0:0] tmpIO_0__Gate_Start_net;
	wire [0:0] tmpINTERRUPT_0__Gate_Start_net;
	electrical [0:0] tmpSIOVREF__Gate_Start_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Gate_Start
		 (.oe(tmpOE__Gate_Start_net),
		  .y({1'b0}),
		  .fb({Net_563}),
		  .io({tmpIO_0__Gate_Start_net[0:0]}),
		  .siovref(tmpSIOVREF__Gate_Start_net),
		  .interrupt({tmpINTERRUPT_0__Gate_Start_net[0:0]}),
		  .annotation({Net_560}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Gate_Start_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
