...
;==============================================================================
    ...
    IMPORT SW_uartDebug_pinNumber
    IMPORT SW_uartDebug_pinPortNumber
    IMPORT SW_uartDebug_pinDrAdress
...
; void SW_uartDebug_PutChar(uint8 txDataByte)
    ALIGN 8
SW_uartDebug_PutChar FUNCTION
    EXPORT SW_uartDebug_PutChar
...
PIN_NUMBER DCD SW_uartDebug_pinNumber
PORT_NUMBER DCD SW_uartDebug_pinPortNumber
PORT_DR_ADDRESS DCD SW_uartDebug_pinDrAdress
