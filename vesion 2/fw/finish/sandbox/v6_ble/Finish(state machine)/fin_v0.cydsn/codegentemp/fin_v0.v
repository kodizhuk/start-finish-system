...
// SwSPI_Master_v1_20(Delay_High_State=20, Delay_Low_State=20, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SwSPI_Master_v1_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SwSPI_Master, CY_INSTANCE_SHORT_NAME=SwSPI_Master, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=SwSPI_Master, )
module SwSPI_Master_v1_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("40a295f4-5414-44bc-8e97-b8ba400379e0/8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("40a295f4-5414-44bc-8e97-b8ba400379e0/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("40a295f4-5414-44bc-8e97-b8ba400379e0/a67a8f19-88f1-4f46-a8b4-672077a3e1c9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("40a295f4-5414-44bc-8e97-b8ba400379e0/e5893258-c96e-41a9-a414-5c745b30282e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    SwSPI_Master_v1_20_3 SwSPI_Master ();
	...
	cy_psoc3_pins_v1_10
		#(.id("ff21b4f4-325c-48fd-8dff-3a5702b4e431"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
