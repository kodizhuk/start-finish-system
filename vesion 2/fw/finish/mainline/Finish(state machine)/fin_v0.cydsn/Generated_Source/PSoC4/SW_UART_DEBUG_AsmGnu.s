/******************************************************************************
* File Name: SW_UART_DEBUG_AsmGnu.s
* Version 1.50
*
*  Description:
...
.global SW_UART_DEBUG_pinNumber
.global SW_UART_DEBUG_pinPortNumber
...
.global SW_UART_DEBUG_PutChar
.func SW_UART_DEBUG_PutChar, SW_UART_DEBUG_PutChar
.type SW_UART_DEBUG_PutChar, %function
.thumb_func
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word SW_UART_DEBUG_pinNumber
PORT_NUMBER:
    .word SW_UART_DEBUG_pinPortNumber
PORT_DR_ADDRESS:
    .word SW_UART_DEBUG_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 9600
