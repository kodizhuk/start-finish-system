...
;==============================================================================
    ...
    IMPORT SW_UART_P_pinNumber
    IMPORT SW_UART_P_pinPortNumber
    IMPORT SW_UART_P_pinDrAdress
...
;-------------------------------------------------------------------------------
; Function Name: SW_UART_P_PutChar
;-------------------------------------------------------------------------------
;
; Summary:
...
; void SW_UART_P_PutChar(uint8 txDataByte)
    ALIGN 8
SW_UART_P_PutChar FUNCTION
    EXPORT SW_UART_P_PutChar
...
PIN_NUMBER DCD SW_UART_P_pinNumber
PORT_NUMBER DCD SW_UART_P_pinPortNumber
PORT_DR_ADDRESS DCD SW_UART_P_pinDrAdress
