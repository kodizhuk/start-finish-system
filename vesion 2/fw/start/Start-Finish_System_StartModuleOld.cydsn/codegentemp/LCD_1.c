...
void LCD_1_IsReady(void) 
{
    ...
    /* Clear LCD port*/
    LCD_1_PORT_DR_REG &= ((uint32)(~LCD_1_PORT_MASK));
    ...
    */
    ...
    /* Make sure RS is low */
    LCD_1_PORT_DR_REG &= ((uint32)(~LCD_1_RS));
    ...
    do
    {
        ...
        /* Set enable low */
        LCD_1_PORT_DR_REG &= ((uint32)(~LCD_1_E));
    ...
    LCD_1_PORT_DR_REG &= ((uint32)(~LCD_1_RW));
...
static void LCD_1_WrDatNib(uint8 nibble) 
{
    ...
    /* Clear data pins */
    LCD_1_PORT_DR_REG &= ((uint32)(~LCD_1_DATA_MASK));
...
static void LCD_1_WrCntrlNib(uint8 nibble) 
{
    ...
    LCD_1_PORT_DR_REG &= ((uint32)(~(LCD_1_RS | LCD_1_RW)));
