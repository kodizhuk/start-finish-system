...
# Project: D:\Cypress\system-start-finish\vesion 2\fw\start\sandbox\v6_debug_ntp\Start(state machine)\start_v0.cydsn\start_v0.cyprj
# Date: Fri, 09 Dec 2016 12:00:45 GMT
#set_units -time ns
...
# Component constraints for D:\Cypress\system-start-finish\vesion 2\fw\start\sandbox\v6_debug_ntp\Start(state machine)\start_v0.cydsn\TopDesign\TopDesign.cysch
# Project: D:\Cypress\system-start-finish\vesion 2\fw\start\sandbox\v6_debug_ntp\Start(state machine)\start_v0.cydsn\start_v0.cyprj
# Date: Fri, 09 Dec 2016 12:00:34 GMT
