...
//#define SELECT()	0//PORTB &= ~_BV(3)	/* CS = L */
//#define	DESELECT()	0//PORTB |=  _BV(3)	/* CS = H */
//#define	MMC_SEL		0//!(PORTB &  _BV(3))	/* CS status (true:CS == L) */
...
#define xmit_spi(x) SPI_SendByte(x)
#define init_spi() SPI_Init()
#define dly_100us() CyDelayUs(100) 
#define rcv_spi() SPI_RecvByte()
#define DESELECT() ChipDeselect()
#define SELECT() ChipSelect()
