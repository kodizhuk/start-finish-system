/******************************************************************************
* File Name: SW_uartDebug_AsmGnu.s
* Version 1.50
*
*  Description:
...
.global SW_uartDebug_pinNumber
.global SW_uartDebug_pinPortNumber
...
/******************************************************************************
* Function Name: SW_uartDebug_PutChar
*******************************************************************************
*
* Summary:
...
.global SW_uartDebug_PutChar
.func SW_uartDebug_PutChar, SW_uartDebug_PutChar
.type SW_uartDebug_PutChar, %function
.thumb_func
SW_uartDebug_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word SW_uartDebug_pinNumber
PORT_NUMBER:
    .word SW_uartDebug_pinPortNumber
PORT_DR_ADDRESS:
    .word SW_uartDebug_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 9600
