...
;==============================================================================
    ...
    IMPORT SW_UART_PC_pinNumber
    IMPORT SW_UART_PC_pinPortNumber
    IMPORT SW_UART_PC_pinDrAdress
...
;-------------------------------------------------------------------------------
; Function Name: SW_UART_PC_PutChar
;-------------------------------------------------------------------------------
;
; Summary:
...
; void SW_UART_PC_PutChar(uint8 txDataByte)
    ALIGN 8
SW_UART_PC_PutChar FUNCTION
    EXPORT SW_UART_PC_PutChar
...
PIN_NUMBER DCD SW_UART_PC_pinNumber
PORT_NUMBER DCD SW_UART_PC_pinPortNumber
PORT_DR_ADDRESS DCD SW_UART_PC_pinDrAdress
