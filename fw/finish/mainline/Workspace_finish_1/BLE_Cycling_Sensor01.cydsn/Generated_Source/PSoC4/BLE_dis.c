...
{
    0x0026u,    /* Handle of the DIS service */
    {
        0x0028u, /* Handle of the Manufacturer Name String characteristic */ 
        0x002Au, /* Handle of the Model Number String characteristic */ 
        CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Serial Number String characteristic */ 
        0x002Cu, /* Handle of the Hardware Revision String characteristic */ 
