...
void UART_PC_UartPostEnable(void)
{
        ...
        if (UART_PC_CHECK_TX_SCL_MISO_PIN_USED)
        {
            /* Set SCB UART to drive the output pin */
            UART_PC_SET_HSIOM_SEL(UART_PC_TX_SCL_MISO_HSIOM_REG, UART_PC_TX_SCL_MISO_HSIOM_MASK,
                                           UART_PC_TX_SCL_MISO_HSIOM_POS, UART_PC_TX_SCL_MISO_HSIOM_SEL_UART);
        }
    #endif /* (UART_PC_TX_SCL_MISO_PIN_PIN) */
...
void UART_PC_UartStop(void)
{
        ...
        if (UART_PC_CHECK_TX_SCL_MISO_PIN_USED)
        {
            ...
            UART_PC_SET_HSIOM_SEL(UART_PC_TX_SCL_MISO_HSIOM_REG, UART_PC_TX_SCL_MISO_HSIOM_MASK,
                                           UART_PC_TX_SCL_MISO_HSIOM_POS, UART_PC_TX_SCL_MISO_HSIOM_SEL_GPIO);
        }
    #endif /* (UART_PC_TX_SCL_MISO_PIN_PIN) */
